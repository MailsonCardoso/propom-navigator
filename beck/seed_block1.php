...
// Limpar questões anteriores se desejar, ou apenas adicionar
// Question::truncate();
...
$questions = [
    ...
    [
        'block' => 1,
        'subject' => 'portugues',
        'text' => 'A palavra "atropelado" deriva da palavra "atropelar". Esse processo de formation é:',
    ...
    [
        'block' => 1,
        'subject' => 'matematica',
        'text' => "Matemática (Questões 21 a 40)\nUm marinheiro ganha R$ 2.400,00 por mês. Ele gasta 25% do seu salário com aluguel. Qual o valor pago no aluguel?",
    ...
    [
        ...
        'options' => ['21 m^2', '42 m^2', '80 m^2', '90 m^2'],
        'correct_answer' => 3,
    ...
    [
        ...
        'options' => ['21', '13', '11', '9'],
        'correct_answer' => 1,
        'rationale' => 'Segue-se a ordem: multiplicação primeiro. 3 x 5 = 15. Então 2 + 15 - 4 = 13.',
    ...
    [
        ...
        'hint' => 'Use a^2 = b^2 + c^2, onde 5 é a hipotenusa.'
    ],
    [
        'block' => 1,
        'subject' => 'matematica',
    ...
    [
        ...
        'correct_answer' => 1,
        'rationale' => 'Volume = 2 x 2 x 2 = 8 m^3. Como 1 m^3 = 1000 L, temos 8.000 L.',
    ...
    [
        'block' => 1,
        'subject' => 'matematica',
        'text' => 'Se um ângulo mede 40 graus, qual o seu complemento?',
        'options' => ['40 graus', '50 graus', '60 graus', '140 graus'],
        'correct_answer' => 1,
        'rationale' => 'Ângulos complementares somam 90 graus. 90 - 40 = 50.',
...
echo "Bloco 1 semeado com sucesso!\n";
