        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6 animate-fade-in">
              ...
              <span className="text-sm text-white/90 font-medium">Um preparatório para ajudar você na prova</span>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="card-elevated gradient-navy p-12 text-center rounded-3xl relative overflow-hidden">
            ...
            <p className="text-white/80 mb-10 max-w-2xl mx-auto text-lg relative z-10">
              Acesso vitalício a todos os 5 blocos de simulados por pagamento único de R$ 50,00.
